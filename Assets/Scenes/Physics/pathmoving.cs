...
public class pathmoving : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            pathCreator.path.vertices[i] = new Vector3(pathCreator.path.vertices[i].x, transform.parent.position.y + pathCreator.path.vertices[i].y, pathCreator.path.vertices[i].z);
        }
